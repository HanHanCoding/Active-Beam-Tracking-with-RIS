...
rate_range_all_LSTM = importdata('rate_range_all.mat');

% for proposed method
rate_range_LSTM = zeros(sample_x, sample_y, total_frames);
% for x
for kk = 1:total_frames
    for ii = 1:sample_x
        % for y
        for jj = 1:sample_y
            rate_range_LSTM(ii, jj, kk) = rate_range_all_LSTM(sample_y*(ii-1)+jj, 1, kk);
        end
    end
end


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Visualize the proposed approach
...
% frame = 1
nexttile
pcolor(range_coordinate_all_x, range_coordinate_all_y, rate_range_LSTM(:,:,1).') %%%%%%%%%%%%%%%%% 注意！这里对rate_range这个矩阵需要转置一下！！！
colorbar
shading interp
hold on
...
% frame = 181
nexttile
pcolor(range_coordinate_all_x, range_coordinate_all_y, rate_range_LSTM(:,:,181).')
colorbar
shading interp
hold on
...
% frame = 271
nexttile
pcolor(range_coordinate_all_x, range_coordinate_all_y, rate_range_LSTM(:,:,271).')
colorbar
shading interp
hold on
...
% frame = 451
nexttile
pcolor(range_coordinate_all_x, range_coordinate_all_y, rate_range_LSTM(:,:,451).')
colorbar
shading interp
hold on
...
% frame = 721
nexttile
pcolor(range_coordinate_all_x, range_coordinate_all_y, rate_range_LSTM(:,:,721).')
colorbar
shading interp
hold on
...
% frame = 811
nexttile
pcolor(range_coordinate_all_x, range_coordinate_all_y, rate_range_LSTM(:,:,811).')
colorbar
shading interp
hold on
...
% frame = 901
nexttile
pcolor(range_coordinate_all_x, range_coordinate_all_y, rate_range_LSTM(:,:,901).')
colorbar
shading interp
hold on
