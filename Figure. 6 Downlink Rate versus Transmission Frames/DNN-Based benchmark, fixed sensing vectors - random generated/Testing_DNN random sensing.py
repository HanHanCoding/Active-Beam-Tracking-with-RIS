...
###########################################################################################################################
# save the data
trained_rate_perframe_DNN_random = np.array(trained_rate_perblock).reshape([total_blocks, 1])
print('\n trained_rate_perframe_DNN_random',trained_rate_perframe_DNN_random)

# save the recorded data
file_path_trained_rate_perframe_DNN_random = 'trained_rate_perframe_DNN_random.mat'

sio.savemat(file_path_trained_rate_perframe_DNN_random, {'trained_rate_perframe_DNN_random': trained_rate_perframe_DNN_random})
