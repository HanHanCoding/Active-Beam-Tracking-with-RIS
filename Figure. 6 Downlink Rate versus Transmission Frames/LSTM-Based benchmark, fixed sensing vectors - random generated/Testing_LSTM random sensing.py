...
##############################################
    ...
    real_v0 = tf.get_variable('real_v0', shape=(num_ris_elements, tau), trainable=False)
    imag_v0 = tf.get_variable('imag_v0', shape=(num_ris_elements, tau), trainable=False)
...
###########################################################################################################################
# save the data
trained_rate_perframe_LSTM_random = np.array(trained_rate_perblock).reshape([total_blocks, 1])

print('\n trained_rate_perframe_LSTM_random',trained_rate_perframe_LSTM_random)

# save the recorded data
file_path_trained_rate_perframe_LSTM_random = 'trained_rate_perframe_LSTM_random.mat'

sio.savemat(file_path_trained_rate_perframe_LSTM_random, {'trained_rate_perframe_LSTM_random': trained_rate_perframe_LSTM_random})
