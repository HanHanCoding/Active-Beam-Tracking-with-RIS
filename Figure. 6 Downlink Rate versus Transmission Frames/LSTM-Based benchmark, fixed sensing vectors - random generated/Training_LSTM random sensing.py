...
#######################################################################################################################
    ...
    for frame in range(frames):
        ...
        for t in range(tau):
            ...
            y_noiseless = tf.reduce_sum(tf.multiply(v_her_complex[:,:,t], channel_cascaded_input[((frame*N_w_using) * batch_size_test_1block): ((frame*N_w_using+1) * batch_size_test_1block), :]), 1, keepdims=True)
...
# here, we directly feed it as a whole
